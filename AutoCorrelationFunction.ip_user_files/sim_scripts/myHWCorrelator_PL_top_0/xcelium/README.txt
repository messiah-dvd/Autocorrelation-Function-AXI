...
#
# Generated by export_simulation on Wed Dec 04 09:29:44 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './myHWCorrelator_PL_top_0.sh' script.

./myHWCorrelator_PL_top_0.sh -reset_run
...
./myHWCorrelator_PL_top_0.sh -noclean_files

For more information on the script, please type './myHWCorrelator_PL_top_0.sh -help'.
