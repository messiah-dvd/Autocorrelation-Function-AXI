...
HD_PWD='C:/Vitis/Vivado/custom_ip_repo/Autocorrelation-Function-AXI/AutoCorrelationFunction.runs/myHWCorrelator_PL_top_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myHWCorrelator_PL_top_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myHWCorrelator_PL_top_0.tcl
