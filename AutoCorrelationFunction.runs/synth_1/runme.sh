...
HD_PWD='C:/Vitis/Vivado/custom_ip_repo/Autocorrelation-Function-AXI/AutoCorrelationFunction.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AutoCorrelationFunction_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AutoCorrelationFunction_v1_0.tcl
