...
HD_PWD='C:/Vitis/Vivado/custom_ip_repo/Autocorrelation-Function-AXI/AutoCorrelationFunction.runs/dual_port_acf_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dual_port_acf_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dual_port_acf_bram.tcl
